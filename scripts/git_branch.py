...
def inject_version(env):
    ...
    # DogeReader: a base version carrying an explicit fork suffix (e.g. "-Tarot")
    # is treated as a release-style clean version; otherwise append dev+branch+sha.
    if base_version.endswith('-Tarot'):
